...
<html lang="es">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <center><h1 style="color:#8A2BE2">Lista de Inscritos</h1></center>
                    <a href="MainServlet?op=nuevo"><button type="button" class="btn btn-outline-danger">Nuevo Registro</button></a>
